                ...
                <div class="col-6">
                    <div class="form-group mt-1">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                               required name="name" value="{{$product->Nameproject}}">
                    </div>
                        ...
                        <select class="form-control col-4" required name="dep_id">
                            @foreach($dep as $list)
                                @if($list->id == $product->dep_id)
                                    <option value="{{$list->id}}" selected>{{$list->Dep}}</option>
                                @else
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="Dete" class="form-control" id="exampleInputPassword1" value="{{$product->Dete}}">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">หมายเหตุ :</label>
                        <input type="text" name="Note" class="form-control" aria-describedby="emailHelp" value="{{$product->Note}}">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <button class="btn btn-outline-success add" type="button" id="inputGroupFileAddon03">Add
                            </button>
                            <button class="btn btn-outline-danger remove" type="button" id="inputGroupFileAddon03">
                                Remove
                            </button>
                        </div>
                        <input type="file" accept=".docx,.pdf" name="File[]">
                    </div>
                    <div id="new_chq"></div>
